...
const initialTutors = [
    { id: '1', name: 'Mr Christopher Skinner', subject: 'Mathematics', rating: 4.5, lastSession: '2 days ago', sessions: 18, avatar: '/path/to/tutor1.jpg' },
    { id: '2', name: 'Mr Ntuthuko Kubeka', subject: 'Mathematics', rating: 4.5, lastSession: '2 days ago', sessions: 18, avatar: '/path/to/tutor2.jpg' },
    { id: '3', name: 'Mr Nkululeko Mdhluli', subject: 'Mathematics', rating: 4.5, lastSession: '2 days ago', sessions: 18, avatar: '/path/to/tutor3.jpg' },
    { id: '4', name: 'Miss Destiny Mabwe', subject: 'Mathematics', rating: 4.5, lastSession: '7 days ago', sessions: 10, avatar: '/path/to/tutor4.jpg' },
    { id: '5', name: 'Miss Khwezi Mpumela', subject: 'Mathematics', rating: 4.5, lastSession: '7 days ago', sessions: 10, avatar: '/path/to/tutor5.jpg' },
    { id: '6', name: 'Mr John Smith', subject: 'Mathematics', rating: 4.5, lastSession: '7 days ago', sessions: 10, avatar: '/path/to/tutor6.jpg' },
];
