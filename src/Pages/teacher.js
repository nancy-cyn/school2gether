    ...
    <>
      <div style={{
        ...
        <div style={{
          ...
          {/* Second Ellipse (Pale Purple) - BEHIND everything */}
          <div style={{
            width: '751.67px',
            height: '751.67px',
        ...
        {/* First Ellipse (Mint Green) - MIDDLE layer */}
        <div style={{
          width: '490px',
          height: '490px',
      ...
      <div style={{
        ...
        <p style={{
          ...
          Share your expertise and connect with learners who need your help. Manage your schedule, track earnings, and build meaningful learning experiences with ease.
        </p>
